...
import com.upc.mofang.utils.Picture4;
import com.upc.mofang.utils.Picture5;

public class Game7 extends GridLayout{
	public int piece = 7;// 几乘几
	// 每张图片的宽度
	...
	private Picture5[][] pictureMap = new Picture5[piece][piece];

	public Game7(Context context) {
		super(context);
		initGameView();
	}

	public Game7(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initGameView();
	}

	public Game7(Context context, AttributeSet attrs) {
		super(context, attrs);
		initGameView();
	}
	...
	public void startGame() {
		GameEight.getGameEight().clearType();
	}
	...
	protected void addpicture(int pictureWidth, int pictureHeight) {
		Picture5 picture = null;
		int a = 0;
		for (int x = 0; x < piece; x++) {
			for (int y = 0; y < piece; y++) {
				picture = new Picture5(getContext());
				a++;
				picture.setNum(a);
		...
		for (int i = 0; i < 20; i++) {
			...
			float c = ((int) (Math.random() * piece)) * Game7.pictureWidth;
			switch (b) {
			case 1:
				swipeDown(c);
				break;
	...
	private void swipeUp(float startX) {
		GameEight.getGameEight().addType(1);
		int num;
		...
		case 0:// 第一列
			...
			pictureMap[6][0].setNum(pictureMap[6][0].getNum());
			pictureMap[6][0].setNum(num);
			break;
		case 1:// 第二列
	...
	private void swipeDown(float startX) {
		...
		case 0:// 第一列
			num = pictureMap[0][0].getNum();
			pictureMap[0][0].setNum(pictureMap[6][0].getNum());
		...
		case 1:// 第二列
			num = pictureMap[0][1].getNum();
			pictureMap[0][1].setNum(pictureMap[6][1].getNum());
		...
		case 2:// 第三列
			num = pictureMap[0][2].getNum();
			pictureMap[0][2].setNum(pictureMap[6][2].getNum());
		...
		case 3:// 第四列
			num = pictureMap[0][3].getNum();
			pictureMap[0][3].setNum(pictureMap[6][3].getNum());
		...
		case 4:// 第五列
			num = pictureMap[0][4].getNum();
			pictureMap[0][4].setNum(pictureMap[6][4].getNum());
		...
		case 5:// 第六列
			num = pictureMap[0][5].getNum();
			pictureMap[0][5].setNum(pictureMap[6][5].getNum());
		...
		case 6:// 第七列
			num = pictureMap[0][6].getNum();
			pictureMap[0][6].setNum(pictureMap[6][6].getNum());
	...
	private void swipeRight(float startY) {
		...
		case 0:// 第一行
			num = pictureMap[0][0].getNum();
			pictureMap[0][0].setNum(pictureMap[0][6].getNum());
		...
		case 1:// 第二行
			num = pictureMap[1][0].getNum();
			pictureMap[1][0].setNum(pictureMap[1][6].getNum());
		...
		case 2:// 第三行
			num = pictureMap[2][0].getNum();
			pictureMap[2][0].setNum(pictureMap[2][6].getNum());
		...
		case 3:// 第四行
			num = pictureMap[3][0].getNum();
			pictureMap[3][0].setNum(pictureMap[3][6].getNum());
		...
		case 4:// 第五行
			num = pictureMap[4][0].getNum();
			pictureMap[4][0].setNum(pictureMap[4][6].getNum());
		...
		case 5:// 第六行
			num = pictureMap[5][0].getNum();
			pictureMap[5][0].setNum(pictureMap[5][6].getNum());
		...
		case 6:// 第七行
			num = pictureMap[6][0].getNum();
			pictureMap[6][0].setNum(pictureMap[6][6].getNum());
