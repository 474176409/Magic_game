...
public class Game2 extends GridLayout{
	...
	public Game2(Context context, AttributeSet attrs, int defStyle) {
	...
	public void startGame() {
		GameThree.getGameThree().clearType();
	}
	...
	protected void addpicture(int pictureWidth, int pictureHeight) {
		...
		for (int i = 0; i < 20; i++) {
			...
			float c = ((int) (Math.random() * piece)) * Game2.pictureWidth;
			switch (b) {
			case 1:
				swipeDown(c);
				break;
	...
	private void swipeDown(float startX) {
		GameThree.getGameThree().addType(1);
		int num;
