...
/*
 * 第二中难度
 * 3*3每一行，每一列，每一斜的相加都相等
 */
public class Game1 extends GridLayout {
	...
	public void startGame() {
		GameTwo.getGameTwo().clearType();
	}

	public void isGameEnd() {
		boolean isEnd = true;
		if(
				((pictureMap[0][0].getNum()+pictureMap[0][1].getNum()+pictureMap[0][2].getNum())!=15)
				||((pictureMap[1][0].getNum()+pictureMap[1][1].getNum()+pictureMap[1][2].getNum())!=15)
				||((pictureMap[2][0].getNum()+pictureMap[2][1].getNum()+pictureMap[2][2].getNum())!=15)
				||((pictureMap[0][0].getNum()+pictureMap[1][0].getNum()+pictureMap[2][0].getNum())!=15)
				||((pictureMap[0][1].getNum()+pictureMap[1][1].getNum()+pictureMap[2][1].getNum())!=15)
				||((pictureMap[0][2].getNum()+pictureMap[1][2].getNum()+pictureMap[2][2].getNum())!=15)
				||((pictureMap[0][0].getNum()+pictureMap[1][1].getNum()+pictureMap[2][2].getNum())!=15)
				||((pictureMap[2][0].getNum()+pictureMap[1][1].getNum()+pictureMap[0][2].getNum())!=15)	
				){
			isEnd = false;
		}
	...
	protected void addpicture(int pictureWidth, int pictureHeight) {
		...
		for (int i = 0; i < 20; i++) {
			...
			float c = ((int) (Math.random() * piece)) * Game1.pictureWidth;
			switch (b) {
			case 1:
				swipeDown(c);
				break;
